...
void loop() {
  if ( mode == 0 ) {
    ...
    if ( ana_count == 0 ) {
      webSocket.sendTXT(client_id, "am56:" + String(ana_val) + "&" + String(led_val));
    }
    delay(100);
    ...
    if(cap_sensor.onChange()) {
      ...
      ledcWrite(pwm_ch, capa_val);
      //Serial.print("capa: ");
      //Serial.println(capa_val);
      webSocket.sendTXT(client_id, "am57:" + String(capa_val));
    }
  }
